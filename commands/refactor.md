...
```bash
python3 ~/Dev/tools/dev/lib/tools/ssot/paths.py rewrite-dead --dry-run   # 预览
# --dry 开启 → 中止
python3 ~/Dev/tools/dev/lib/tools/ssot/paths.py rewrite-dead             # 实跑
```

#### Step 6 · build-const 刷派生

```bash
python3 ~/Dev/tools/dev/lib/tools/ssot/paths.py build-const -w
```

#### Step 6.5 · rewrite-allow-missing

```bash
python3 ~/Dev/tools/dev/lib/tools/ssot/paths.py rewrite-allow-missing --apply
```
...
```bash
python3 ~/Dev/tools/dev/lib/tools/ssot/paths.py rebuild-symlinks --apply --backup
```
...
```bash
python3 ~/Dev/tools/dev/lib/tools/ssot/paths.py scan-symlinks --strict
```
...
```bash
python3 ~/Dev/tools/dev/lib/tools/ssot/paths.py scan-dead --strict
```
...
- `~/Dev/tools/dev/lib/tools/ssot/paths.py`（CLI）
...
```bash
python3 ~/Dev/tools/dev/lib/tools/ssot/classify.py $ARGUMENTS
```
...
```bash
python3 ~/Dev/tools/dev/lib/tools/oneshot/stack_migrate_hydro.py $ARGUMENTS
```
