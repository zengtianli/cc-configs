...
python3 ~/Dev/tools/dev/lib/tools/scaffold/scaffold.py preview <project> --kind wiki-mainpage

# 渲染单条目
python3 ~/Dev/tools/dev/lib/tools/scaffold/scaffold.py preview <project> --kind wiki-entry

# 一键初始化 docs/wiki/ + WIKI.md 骨架
python3 ~/Dev/tools/dev/lib/tools/scaffold/scaffold.py wiki-init <project> [--topic proxy-and-vpn]
```
...
```bash
python3 ~/Dev/tools/dev/lib/tools/wikigen/wiki.py sync link <project>
